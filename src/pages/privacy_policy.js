...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <strong>Last updated August 12, 2024</strong>
      <p>
      ...
      <p>
        <strong>Questions or concerns?</strong> Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at contact@thimble.dev.
      </p>
      <h2>SUMMARY OF KEY POINTS</h2>
      <p class="italic">This summary provides key points from our privacy notice, but you can find out more detalls about any of these topics by clicking the link following each key point or by using our table of contents below to find the section you are looking for.</p>
      <p>
