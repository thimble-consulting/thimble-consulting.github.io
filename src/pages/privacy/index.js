...
function UnorderedList({ children }) {
  return (
    <ul className="mx-12">{ children }</ul>
  )
}

function ListItem({ children }) {
  return (
    <li className="list-item list-disc">{ children }</li>
  )
}
  ...
  return (
    <Layout>
      <div className="my-6 mx-4">
        <h1 className="text-3xl mb-5">Privacy Policy for Thimble Consulting</h1>
        <section>
          <Paragraph>Last updated: August 09, 2024</Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            ...
            Policy has been created with the help of the <Link to="https://www.freeparagrapholicy.com/free-privacy-policy-generator/">
        ...
        <section>
          ...
          <UnorderedList>
            ...
            <ListItem>
              <Paragraph>
                <strong>Affliate</strong> means an entity that controls, is
            ...
            <ListItem>
              <Paragraph>
                ...
                "We", "Us" or "Our" in this Agreement) refers to JBT Consulting
                Ltd, 82 Sandringham Road, London, England, E8 2LL.
              </Paragraph>
            </ListItem>
            <ListItem>
              <Paragraph>
            ...
            <ListItem>
              <Paragraph><strong>Country</strong> refers to: United Kingdom</Paragraph>
            </ListItem>
            <ListItem>
              <Paragraph>
            ...
            <ListItem>
              <Paragraph>
                <strong>Website</strong> refers to Thimble Consulting,
                accessible from <Link to="https://thimble.dev/">https://thimble.dev/</Link>
              </Paragraph>
            </ListItem>
            <ListItem>
              <Paragraph>
        ...
        <section>
          ...
          <UnorderedList>
            <ListItem><Paragraph>Email address</Paragraph></ListItem>
            <ListItem><Paragraph>Usage Data</Paragraph></ListItem>
          </UnorderedList>
          <H4>Usage Data</H4>
          ...
          <Paragraph>
            ...
            Your web browser. Learn more about cookies on the <Link to="https://www.freeparagrapholicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking">
          ...
          <UnorderedList>
            <ListItem><Paragraph>Necessary / Essential Cookies</Paragraph></ListItem>
            ...
            <ListItem><Paragraph>Cookies Policy / Notice Acceptance Cookies</Paragraph></ListItem>
            ...
            <ListItem><Paragraph>Functionality Cookies</Paragraph></ListItem>
            <Paragraph>Type: Persistent Cookies</Paragraph>
            <Paragraph>Administered by: Us</Paragraph>
            <Paragraph>
          ...
          <UnorderedList>
            <ListItem><Paragraph>Comply with a legal obligation</Paragraph></ListItem>
            <ListItem><Paragraph>
            ...
            <ListItem><Paragraph>Protect against legal liability</Paragraph></ListItem>
          </UnorderedList>
        ...
        <section>
          ...
          <Paragraph>
            ...
            contact us by email: <a href="mailto:contact@thimble.dev">contact@thimble.dev</a>
          </Paragraph>
        </section>
      </div>
    </Layout>
