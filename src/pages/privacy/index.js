      ...
      <div className="my-6">
        ...
        <div className="privacy-section">
          ...
          <p>
            ...
            Policy has been created with the help of the <Link to="https://www.freeprivacypolicy.com/free-privacy-policy-generator/">
        ...
        <div className="privacy-section">
          ...
          <ul>
            <li className="list-item list-disc"><p>Email address</p></li>
            <li className="list-item list-disc"><p>Usage Data</p></li>
          </ul>
          ...
          <p>
            ...
            Your web browser. Learn more about cookies on the <Link to="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking">
          ...
          <ul>
            <li className="list-item list-disc"><p>Necessary / Essential Cookies</p></li>
            ...
            <li className="list-item list-disc"><p>Cookies Policy / Notice Acceptance Cookies</p></li>
            ...
            <li className="list-item list-disc"><p>Functionality Cookies</p></li>
            <p>Type: Persistent Cookies</p>
            <p>Administered by: Us</p>
            <p>
          ...
          <ul>
            <li className="list-item list-disc"><p>Comply with a legal obligation</p></li>
            <li className="list-item list-disc"><p>
            ...
            <li className="list-item list-disc"><p>Protect against legal liability</p></li>
          </ul>
